...
//
// Rail is trimmed for the kiosk: the "(AR)" collections are redundant alternate
// groupings of products that already live in the main categories (e.g. Søtsaker
// (AR) → Sjokolader & Snacks, Krydder (AR) → Krydder/Saus/Buljong), so they're
// marked `hidden` here to declutter the rail — the products stay reachable via
// their main category and the full-range search. Flip `hidden` to bring one back.
...
export const CATEGORIES: KioskCategory[] = [
  ...
  { id: C("300018041024"), handle: "sotsaker-ar", name: "Søtsaker (AR)", icon: "🍬", count: 195, hidden: true }, // redundant with Sjokolader & Snacks
  { id: C("293702467776"), handle: "mel-sukker", name: "Kornprodukter & Ris", icon: "🌾", count: 164 },
  { id: C("299018256576"), handle: "krydder-ar", name: "Krydder (AR)", icon: "🌶️", count: 162, hidden: true }, // redundant with Krydder, Saus & Buljong
  ...
  { id: C("298678517952"), handle: "te-kaffe", name: "Kaffe & Te (AR)", icon: "☕", count: 94, hidden: true }, // redundant with Te & Kaffe
  ...
  { id: C("299018322112"), handle: "drikkevarer-ar", name: "Drikkevarer (AR)", icon: "🥤", count: 80, hidden: true }, // redundant with Juice & Drikkevarer
  ...
  { id: C("300455788736"), handle: "tahin-halawa", name: "Tahina & Halawa (AR)", icon: "🍯", count: 38, hidden: true }, // niche AR specialty — reachable via search
  ...
  { id: C("296124186816"), handle: "kakaopulver", name: "Kakaopulver", icon: "🍫", count: 2, hidden: true }, // only 2 products — too thin for its own tab
